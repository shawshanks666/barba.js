...
function animateSlide(){
    ...
    sliders.forEach((slide, index, slides) => {
        ...
        pageTl.fromTo(nextSlide, { y: "0%" }, { y: "80%" });
...
function activeCursor(e) {
  ...
  function navToggle(e){
    if(!e.target.classList.contains('active')){
        ...
        gsap.to('.nav-bar', .7 ,{clipPath: 'circle(1700px at 100% -10%)'})
        ...
        gsap.to('.nav-bar', .7 ,{clipPath: 'circle(50px at 100% -10%)'})
    ...
    transitions: [
        {
          ...
          enter({ current, next }) {
            ...
            tl.fromTo(
              ...
              { x: "100%", stagger: .2, onComplete: done }
            );
